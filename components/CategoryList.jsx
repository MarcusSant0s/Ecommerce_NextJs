...
{/* Content */} <div className="mx-auto grid justify-items-stretch gap-4 sm:grid-cols-2 lg:gap-10"> {/* Item */} 
     ...
     <Link href="/products" className="hover:scale-105 transition-all  ease-in  relative flex h-[300px] items-end [grid-area:1/1/3/2] sm:h-auto">
        <Image src={necklace} alt="" className="inline-block h-full w-full rounded-lg object-cover " placeholder='blur'/>
      ...
      </Link> {/* Item */} <Link href="products" className="hover:scale-105 transition-all  ease-in relative flex h-[400px] items-end py-1">
        <Image src={ring} alt="" className="inline-block h-full w-full rounded-lg object-cover "  placeholder='blur'/>
        <div className="absolute bottom-5 left-5 flex flex-col justify-center rounded-lg bg-white px-8 py-4">
        ...
        <Image src={brinc} alt="" className="inline-block h-full w-full rounded-lg object-cover     "  placeholder='blur'/>
        <div className="absolute bottom-5 left-5 flex flex-col justify-center rounded-lg bg-white px-8 py-4">
          <p className="text-sm font-medium sm:text-xl">Brincos</p> 
 
        </div>
      </Link>{/* Item */} <Link href="products" className="hover:scale-105 transition-all  ease-in relative flex h-[300px] items-end sm:col-span-2">
      <Image src={bracel} alt="" className="inline-block h-full w-full rounded-lg object-cover "  placeholder='blur'/>
